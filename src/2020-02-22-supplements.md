...
title: "Supplements"
slug: "supplements"
date: "2020-02-22T04:26:00.023Z"
lastmod: "2025-04-07T18:44:13.486Z"
draft: true
categories: []
aliases: ["/2019/12/supplements.html"]
featured_image: "/images/IMG_5256.jpg"
...
[![](/images/IMG_5256.jpg)](https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhm8UnNSIjZm8n5USN2W0XA6KJTyK2-yRyONXptvUHEnbw4lVb9hNZGtMERrirY7Ual5cPE6M-dkbjvCgZ6IXeTcWVNYTizPn44ytswW2eTlSVjErqVg3_3LTd6QBessKWJBAGSdCjzS-YW/s1600/IMG_5256.jpg)

Flaxmeal** - 1/2 tsp for omega 3's and [more](https://nutritionfacts.org/topics/flax-seeds/)

**

Resveratrol** - 1/4 tsp powder (400 mg) for [longevity and more](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6319551/)

**

Quercetin** -1/4 heaping tsp powder (~400 mg) to boost resveratrol absorption and more, including inducing autophagy and aptosis (cellular [senescence](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6386227/)), and anti-inflammatory, anticarcinogenic, and antiviral [activity](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4808895/).
...
I also sometimes add a half a tsp of beetroot powder **to mine for [cardio](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6947971/) (e.g., blood pressure) benefits.

**

COVID-19 DIGRESSION**

We started taking **quercetin** in December for other benefits (see above). In February, I googled "quercetin coronavirus" given its benefits for [respiratory](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6273625/) health and found that it;s one of many things being tested for [protection against](https://www.cbc.ca/radio/thecurrent/the-current-for-feb-28-2020-1.5479561/as-coronavirus-spread-speeds-up-montreal-researchers-will-trial-an-anti-viral-treatment-for-covid-19-in-china-1.5480134) [COVID-19](https://www.cbc.ca/radio/thecurrent/the-current-for-feb-28-2020-1.5479561/as-coronavirus-spread-speeds-up-montreal-researchers-will-trial-an-anti-viral-treatment-for-covid-19-in-china-1.5480134). Then it appeared as #5 in a [supercomputer](https://www.cnn.com/2020/03/19/us/fastest-supercomputer-coronavirus-scn-trnd/index.html) computation to identify chemicals that could slow the virus. [Quercetin is a zinc ionophore,](https://www.youtube.com/watch?v=vE4_LsftNKM&list=PLQ_IRFkDInv_zLVFTgXA8tW0Mf1iiuuM_&index=36) which means it transports zinc into the cell -- and [zinc shuts down the RNA-dependent RNA polymerase that replicates the virus](https://www.youtube.com/watch?v=U7F1cnWup9M&list=PLQ_IRFkDInv_zLVFTgXA8tW0Mf1iiuuM_&index=35). (Zinc is an ion, and ions can't get through a cellular membrane without a transporter that lets it in. Chloroquine, which was all over the news re: COVID because it's also a zinc ionophore, appears to have more negative side effects.) So everyone in my family started taking quercetin in March. In addition, we're all taking [Vitamin C](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7074424/)**,** [Vitamin D](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7138423/), and small amounts of [zinc](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7074432/) (in a multivitamin) daily, and [melatonin](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7102583/) before bed, since all have some protective promise and are super safe (and cheap). (If any cold/flu symptoms appear, I'll increase quercetin and add zinc lozenges.) Fast forward to April, [EVMC](https://www.evms.edu/media/evms_public/departments/internal_medicine/EVMS_Critical_Care_COVID-19_Protocol.pdf) and [others](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7139252/) are recommending these supplements (e.g., daily: quercetin 500-1000mg, C 1000+ mg, D 2000+IU, zinc 30mg, melatonin 1-3 mg) to aid in COVID-19 prevention. For research updates, I follow (and LOVE) [MedCram](https://www.youtube.com/user/MEDCRAMvideos/videos) medical lectures. The videos are super - e.g., see [Medcram on Vitamin D](https://www.youtube.com/watch?v=gmqgGwT6bw0&list=PLQ_IRFkDInv_zLVFTgXA8tW0Mf1iiuuM_&index=31) and on the [molecular biology behind the virus + zinc transport](https://www.youtube.com/watch?v=U7F1cnWup9M&list=PLQ_IRFkDInv_zLVFTgXA8tW0Mf1iiuuM_&index=35)) -- and later lectures (e.g., episodes 60 and later) that explain how COVID looks like a [disease of the endothelium](https://www.youtube.com/watch?v=Aj2vB_VITXQ) (cells lining blood vessels). ACE2 plays a huge role in keeping our blood vessels healthy. COVID appears to degrade ACE2 in our blood vessels (by attaching to and occupying it), leading to an increase in oxidative stress, coagulation, and clots (resulting in stroke, heart attack, and pulmonary embolisms). This may be a particularly good time in to be plant-based to lower oxidative stress in your body.
...
Elderberry** - a couple of chews is 100 mg; want closer to 500 mg a day for [antiviral](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3056848/) activity**

Vitamin C** - because it supports [immune function](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5707683/) (and w/COVID, taking this more regularly even without symptoms)**

Zinc** lozenges 23 mg - suck 1 or 2 a day, for [antiviral](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6628855/) immunity**
...
Vegan omega 3** - especially for DHA, 250 mg (Gregor [recommends](https://nutritionfacts.org/video/should-vegans-take-dha-to-preserve-brain-function/) 250 mg/day; [read more](https://nutritionfacts.org/topics/omega-3-fatty-acids/)) - though we're both getting a LOT of omega 3 (as ALA) in our morning yogurt with flaxseed (and I get EPA & DHA in my multivitamin chews, which he doesn't take cause they aren't stricktly vegan).
